...
ActiveRecord::Schema.define(version: 20_170_510_023_231) do
  create_table 'addresses', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w[user_id address_type], name: 'index_addresses_on_user_id_and_address_type', using: :btree
  end
  ...
  create_table 'payments', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.decimal  'total_money', precision: 10, scale: 2
    t.datetime 'payment_at'
    t.text     'raw_response', limit: 65_535
    t.datetime 'created_at',                                                                null: false
    t.datetime 'updated_at',                                                                null: false
  ...
  create_table 'products', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w[status category_id], name: 'index_products_on_status_and_category_id', using: :btree
